...
from NextHime.src.modules.create_logger import EasyLogger
from NextHime.src.modules.language_manager import LanguageManager
...
class AutoMigrate(object):
    def __init__(self, language: str = 'ja'):
        ...
        self.language = LanguageManager(
            base_path="./src/language/", lang=f"{language}", module_name="auto_migrate"
        ).get()
